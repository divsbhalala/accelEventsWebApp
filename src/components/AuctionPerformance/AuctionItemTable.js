...
class AuctionItemTable extends React.Component {
	...
	expandColumnComponent({isExpandableRow, isExpanded}) {
		...
		if (isExpandableRow) {
			content = (isExpanded ?
				<span className="fa-stack pointer"><i className="fa fa-circle fa-stack-2x icon-backgroundRed"/><i
					className="fa fa-minus fa-stack-1x fa-lg plus-green white"/></span>
				: <span className="fa-stack pointer"><i className="fa fa-circle fa-stack-2x icon-backgroundGreen"/><i
					className="fa fa-plus fa-stack-1x fa-lg plus-green white"/></span>);
		} else {
			content = ' ';
		}
		return (
