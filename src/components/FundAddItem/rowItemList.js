...
class RowItemList extends React.Component {
	...
	startingBidHandlerChange = (e) => {
		...
		if (this.startingBid.value.trim() === '') {
			...
			this.setState({startingBid: true});
		}
					...
					<div className="flex-col item-starting-bid-column">
						<div className="input-group">
							...
							<input type="text" className="form-control item-bid" name="startingBid"
										 ...
										 }} onKeyUp={this.startingBidHandlerChange} onBlur={this.autoAddData}/>
							{ this.state.startingBidFeedBack && !this.state.startingBid &&
							<small className="error red"> Starting Bid is Required.</small>}
						</div>
					</div>
