		...
		return (
			<div className={cx("onoffswitch", this.props.className ? "onoffswitch-" + this.props.className : "onoffswitch-success")}>
				<input type="checkbox" name={this.props.name} className="onoffswitch-checkbox"
							 id={this.props.id} defaultChecked={this.props.defaultValue} onClick={this.props.onClick} onChange={()=>{ if(this.props.onChange){this.props.onChange()}}} disabled={this.props.disabled} disabled={this.props.disabled}/>
