      ...
      <div className="item-container col-md-6">
        ...
        <div className={cx("action-wrap")}>
          <div className={cx("card-action")}>
            <div className={cx("flex-row")}>
              ...
              <div className={cx("flex-col")}>
                ...
                <a href="http://www.stagingaccel.com:8080/AccelEventsWebApp/events/jkazarian8/A/SLV" className={cx("item-link","btn","btn-sm","btn-info","pull-right")}>More Info</a>
              </div>
            </div>
            <div className={cx("flex-row")}>
              <div className={cx("flex-col")}>
          ...
          <div className={cx("text-center","action-btns")}>
            <a role="button" className={cx("btn","btn-primary","disabled")} data-toggle="modal" href="#info-modal" data-title="Auction Completed" data-message="Bid are no longer being accepted for this auction">Bidding Closed</a>
          </div>
        </div>
      </div>
      </div>
