...
class HeaderNew extends React.Component {
  ...
  render() {
    const event = this.props.params && this.props.params.params;
    return (
        ...
        <Navbar fluid style={{ margin: 0 }}>
          <Brand className={cx(this.props.admin && 'p-0')}>
            <span >
              ...
              <Link
                to={`/event/${this.props.eventData.eventURL}`} title={this.props.eventData.name}
                rel="home"
              >{this.props.eventData.name}</Link>}
              { this.props.admin && <a
                href="http://www.stagingaccel.com:8080/AccelEventsWebApp/host/dashboard/home" id="logo"
              ...
              { this.props.admin && <button
                type="button" className="navbar-toggle" onClick={() => {
                  toggleMenu();
                }}
              >
          ...
          { this.props.admin && <div className="nav-no-collapse navbar-left pull-left hidden-sm hidden-xs">
            <ul className="nav navbar-nav pull-left">
              <li>
                <a
                  className="btn" id="make-small-nav" onClick={() => {
                    toggleSide();
                  }}
                >
          ...
          <ul className="nav navbar-top-links navbar-right">
            ...
            { event && this.props.is_volunteer && !this.props.admin && <MenuItem
              eventKey="3" onClick={() => {
            ...
            <NavDropdown title={<span><i className="fa fa-th-list fa-fw" /> Views</span>} id="navDropdown3">
            ...
            { !this.props.authenticated && <MenuItem
              eventKey="9"
    ...
    <span> <i className="fa fa-sign-out fa-fw" /> Logout </span>
        ...
        >
          <div className="modal-body">
            ...
            <form
              className="ajax-form validated fv-form fv-form-bootstrap" id="contactForm" method="post"
            ...
            >
              ...
              >
                ...
                <div className="input-group">
                  ...
                  <input
                  type="text" className="form-control" id="name" name="name" data-fv-notempty="true"
                  placeholder="Name"
              ...
              >
                ...
                <div className="input-group">
                  ...
                  <input
                  type="email" className="form-control" id="email" name="email" required="required"
                  placeholder="Email"
                  ref={(ref) => {
													 this.email = ref;
												 }}
              ...
              >
                ...
                <div className="input-group">
                  ...
                  <textarea
                    rows={10} className="form-control" id="message" name="message"
                    style={{
                    zIndex: 3,
                    position: 'relative',
                    fontSize: 13,
        ...
        <PopupModel
          ...
          modelFooter={<button
            className="btn btn-green" data-dismiss="modal" onClick={() => {
