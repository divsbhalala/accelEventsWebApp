      ...
      <div id="header-navbar" className={cx("content turquoise-bg white")}>
        ...
        <Navbar fluid={true} style={ {margin: 0} } className={ this.props.admin && "navbar-fixed-top"}>
          ...
          <ul className="nav navbar-top-links navbar-right">
            ...
            { !this.props.user && <MenuItem eventKey="8" onClick={this.showLoginPopup} >
            ...
            { this.state.togale ?
              ...
              <button type="submit" className="btn btn-square btn-green btn-block btn-lg">SIGN UP</button>
                ...
                <p className="mrg-t-md small text-center">
                  By signing up, I agree to Accelevent's <a href="/AccelEventsWebApp/tos" target="_blank">terms of service</a>, <a href="/AccelEventsWebApp/privacypolicy" target="_blank">privacy policy</a>, and <a href="/AccelEventsWebApp/cookies" target="_blank">cookie policy</a>.
                </p>
              </form>
              </div>
              </div> }
