    ...
    return (
      <div id="content-wrapper" className="admin-content-wrapper">
                      ...
                      <div className="main-box-body clearfix">
                        ...
                        <form id="form" className="mrg-t-lg">
                              ...
                              <div className="row stripe-button-group">
                                ...
                                <div className="col-sm-8">
                                  <a
                                    ...
                                    title="Additional Instructions" target="_blank"
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col-md-4">
                              <ToggleSwitch
                                name="creditCardEnabled" id="creditCardEnabled"
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col-md-4">
                              <ToggleSwitch
                                name="ccRequiredForBidConfirm" id="ccRequiredForBidConfirm"
                          ...
                          <div className="form-group row mrg-t-lg">
                            <div className="col-md-4">
                              <a
                                className="btn btn-default btn-block mrg-b-md"
                                onClick={this.toggleItemTransactionsPopup}
                              >View Item Transactions</a>
                            </div>
                          </div>
                          <div />
                        </form>
        ...
        <PopupModel
          ...
          modelFooter={<div>
            <button
              className="btn btn-green" onClick={() => {
