...
import {doGetTicketingSettings, doPostTicketingSettings, doGetTicketingCouponCodes} from '../action';
...
class TicketSetting extends React.Component {
	...
	render() {
		...
		return (
			<div id="content-wrapper" className="admin-content-wrapper theme-turquoise volunteer">
				<style
																	...
																	<div className="form-group">
																		<div className="radio">
																			<input type="radio"
																						 ...
																						 defaultChecked={this.state.settings && this.state.settings.holderAttribute}/>
																			<label htmlFor="each-attendee">158102
															...
															<div className="discount-codes-container">
																...
																<div className="table-responsive discount-codes-table-container">
																	...
																	<BootstrapTable data={this.state.couponCodes} striped hover search  pagination={ true }  options={ options }>
																		...
																		<TableHeaderColumn dataSort  dataField='couponUsed'>USES</TableHeaderColumn>
																		<TableHeaderColumn dataSort  dataField='code'>STARS-ENDS</TableHeaderColumn>
																		<TableHeaderColumn dataSort  dataField='code'></TableHeaderColumn>
																	</BootstrapTable>
																</div>
															</div>
														</div>
			...
			<div id="new-code">
				<PopupModel
					...
					headerText={<p><a href="javascript:void(0)" onClick={()=>{this.setActiveScreen(1)}} className={cx("screen-changer back-btn", this.state.activeScreen === 1 && "hide")} style={{display: 'block'}} data-screen="init">
						<i className="fa fa-angle-left" />
					</a>
						Discount & Access Code</p>}
						...
						<div className="create-coupon-wizard screen-container">
							...
							<div className={cx("screen screen-2", this.state.activeScreen !== 2 && "hide")} data-screen-name="select-ticket-types" data-screen-title="Select Tickets">
								<ul className="top-nav">
									...
									<li> selected <span className="selected-count">5</span> </li>
								</ul>
								<div className="all-tickets">
									<div className><span className="text-uppercase">Ticket Results</span> <span className="selected-count">5</span>  of 5 </div>
									<div className="event-details clearfix">
										<div className="event-name">
											<strong>jkazarian0 at 67-65 Main St, Flushing, NY 11367, USA</strong>
									...
									<ul className="list-unstyled">
										{this.state.couponCodes.map(item => <li>
											<div className="ticketType-name" key={item.code}>
												First Ticket Type
												<div className="checkbox-nice pull-right">
													<input type="checkbox" id="check-34" className="checked-ticket" data-tickettype-id={34} />
													<label htmlFor="check-34" />
												</div>
											</div>
										...
										{
											!this.state.couponCodes.length && <li>
							...
							<div className={cx("screen screen-3", this.state.activeScreen !== 3 && "hide")} data-screen-name="configure-code" data-screen-title="Configure Your Discount Code">
								<div className="configure-form">
									...
									<div className="form-group">
										...
										<div className="form-inline">
											<div className="input-group">
												<select className="form-control" id="uses-dropdown" name="uses-dropdown">
													<option value="Unlimited">Unlimited</option>
													<option value="Limited">Limited</option>
												</select>
											</div>
											<div className="input-group uses-input" style={{display: 'none'}}>
												<input type="text" className="form-control" name="uses" id="uses" />
											</div>
										</div>
									</div>
									<div className="form-group">
										...
										<div className="form-inline">
											<div className="input-group">
												<input type="text" className="datepicker form-control white-bg" name="couponStartDate" id="couponStartDate" placeholder="Start Date" readOnly="readonly" />
											</div>
											<div className="input-group">
												<input type="text" className="datepicker form-control white-bg" name="couponEndDate" id="couponEndDate" placeholder="End Date" readOnly="readonly" />
											</div>
										</div>
									</div>
								</div>
								<div className="text-right">
									<a className="btn btn-info create-code-continue" href="javascript:void(0)">
										Continue
									</a>
								</div>
							</div>
