                        ...
                        <div className="main-box-body clearfix">
                          ...
                          <form method="POST" className="create-event form mrg-t-lg">
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  <div id="eventAddress-map" style={{height: 250, position: 'relative', overflow: 'hidden'}}><div style={{height: '100%', width: '100%', position: 'absolute', top: 0, left: 0, backgroundColor: 'rgb(229, 227, 223)'}}><div className="gm-style" style={{position: 'absolute', zIndex: 0, left: 0, top: 0, height: '100%', width: '100%', padding: 0, borderWidth: 0, margin: 0}}><div tabIndex={0} style={{position: 'absolute', zIndex: 0, left: 0, top: 0, height: '100%', width: '100%', padding: 0, borderWidth: 0, margin: 0, cursor: 'url("http://maps.gstatic.com/mapfiles/openhand_8_8.cur") 8 8, default'}}><div style={{zIndex: 1, position: 'absolute', top: 0, left: 0, width: '100%', transformOrigin: '0px 0px 0px', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}><div style={{position: 'absolute', left: 0, top: 0, zIndex: 100, width: '100%'}}><div style={{position: 'absolute', left: 0, top: 0, zIndex: 0}}><div aria-hidden="true" style={{position: 'absolute', left: 0, top: 0, zIndex: 1, visibility: 'inherit'}}><div style={{width: 256, height: 256, position: 'absolute', left: 167, top: '-75px'}} /><div style={{width: 256, height: 256, position: 'absolute', left: 167, top: 181}} /><div style={{width: 256, height: 256, position: 'absolute', left: '-89px', top: '-75px'}} /><div style={{width: 256, height: 256, position: 'absolute', left: '-89px', top: 181}} /><div style={{width: 256, height: 256, position: 'absolute', left: 423, top: '-75px'}} /><div style={{width: 256, height: 256, position: 'absolute', left: 423, top: 181}} /></div></div></div><div style={{position: 'absolute', left: 0, top: 0, zIndex: 101, width: '100%'}}><div style={{position: 'absolute', left: 0, top: 0, zIndex: 30}}><div aria-hidden="true" style={{position: 'absolute', left: 0, top: 0, zIndex: 1, visibility: 'inherit'}}><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 167, top: '-75px'}}><canvas width={256} height={256} draggable="false" style={{width: 256, height: 256, userSelect: 'none', position: 'absolute', left: 0, top: 0}} /></div><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 167, top: 181}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: '-89px', top: '-75px'}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: '-89px', top: 181}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 423, top: '-75px'}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 423, top: 181}} /></div></div></div><div style={{position: 'absolute', left: 0, top: 0, zIndex: 102, width: '100%'}} /><div style={{position: 'absolute', left: 0, top: 0, zIndex: 103, width: '100%'}}><div style={{position: 'absolute', left: 0, top: 0, zIndex: -1}}><div aria-hidden="true" style={{position: 'absolute', left: 0, top: 0, zIndex: 1, visibility: 'inherit'}}><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 167, top: '-75px'}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 167, top: 181}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: '-89px', top: '-75px'}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: '-89px', top: 181}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 423, top: '-75px'}} /><div style={{width: 256, height: 256, overflow: 'hidden', position: 'absolute', left: 423, top: 181}} /></div></div><div style={{width: 22, height: 40, overflow: 'hidden', position: 'absolute', left: 233, top: 85, zIndex: 125}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi.png" draggable="false" style={{position: 'absolute', left: 0, top: 0, width: 22, height: 40, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div></div><div style={{position: 'absolute', zIndex: 0, left: 0, top: 0}}><div style={{overflow: 'hidden', width: 488, height: 250}}><img src="http://maps.googleapis.com/maps/api/js/StaticMapService.GetMapImage?1m2&1i2473817&2i3153227&2e1&3u15&4m2&1u488&2u250&5m5&1e0&5sen-US&6sus&10b1&12b1&token=69789" style={{width: 488, height: 250}} /></div></div><div style={{position: 'absolute', left: 0, top: 0, zIndex: 0}}><div aria-hidden="true" style={{position: 'absolute', left: 0, top: 0, zIndex: 1, visibility: 'inherit'}}><div style={{position: 'absolute', left: 167, top: 181, transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9664!3i12318!4i256!2m3!1e0!2sm!3i383075492!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=74341" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div style={{position: 'absolute', left: 167, top: '-75px', transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9664!3i12317!4i256!2m3!1e0!2sm!3i383075600!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=81564" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div style={{position: 'absolute', left: 423, top: '-75px', transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9665!3i12317!4i256!2m3!1e0!2sm!3i383075600!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=41843" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div style={{position: 'absolute', left: '-89px', top: '-75px', transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9663!3i12317!4i256!2m3!1e0!2sm!3i383075600!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=121285" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div style={{position: 'absolute', left: '-89px', top: 181, transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9663!3i12318!4i256!2m3!1e0!2sm!3i383075492!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=114062" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div style={{position: 'absolute', left: 423, top: 181, transition: 'opacity 200ms ease-out'}}><img src="http://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i9665!3i12318!4i256!2m3!1e0!2sm!3i383075444!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0&token=70953" draggable="false" alt style={{width: 256, height: 256, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div></div></div></div><div style={{zIndex: 2, position: 'absolute', height: '100%', width: '100%', padding: 0, borderWidth: 0, margin: 0, left: 0, top: 0}} /><div style={{zIndex: 3, position: 'absolute', height: '100%', width: '100%', padding: 0, borderWidth: 0, margin: 0, left: 0, top: 0}}><div style={{zIndex: 1, position: 'absolute', height: '100%', width: '100%', padding: 0, borderWidth: 0, margin: 0, left: 0, top: 0}} /></div><div style={{zIndex: 4, position: 'absolute', top: 0, left: 0, width: '100%', transformOrigin: '0px 0px 0px', transform: 'matrix(1, 0, 0, 1, 0, 0)'}}><div style={{position: 'absolute', left: 0, top: 0, zIndex: 104, width: '100%'}} /><div style={{position: 'absolute', left: 0, top: 0, zIndex: 105, width: '100%'}} /><div style={{position: 'absolute', left: 0, top: 0, zIndex: 106, width: '100%'}}><div className="gmnoprint" style={{width: 22, height: 40, overflow: 'hidden', position: 'absolute', opacity: '0.01', left: 233, top: 85, zIndex: 125}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi.png" draggable="false" useMap="#gmimap0" style={{position: 'absolute', left: 0, top: 0, width: 22, height: 40, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /><map name="gmimap0" id="gmimap0"><area href="javascript:void(0)" log="miw" coords="8,0,5,1,4,2,3,3,2,4,2,5,1,6,1,7,0,8,0,14,1,15,1,16,2,17,2,18,3,19,3,20,4,21,5,22,5,23,6,24,7,25,7,27,8,28,8,29,9,30,9,33,10,34,10,40,11,40,11,34,12,33,12,30,13,29,13,28,14,27,14,25,15,24,16,23,16,22,17,21,18,20,18,19,19,18,19,17,20,16,20,15,21,14,21,8,20,7,20,6,19,5,19,4,18,3,17,2,16,1,14,1,13,0,8,0" shape="poly" title="Drag Me" style={{cursor: 'pointer'}} /></map></div></div><div style={{position: 'absolute', left: 0, top: 0, zIndex: 107, width: '100%'}}><div style={{zIndex: -202, cursor: 'pointer', display: 'none'}}><div style={{width: 30, height: 27, overflow: 'hidden', position: 'absolute'}}><img src="http://maps.gstatic.com/mapfiles/undo_poly.png" draggable="false" style={{position: 'absolute', left: 0, top: 0, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none', width: 90, height: 27}} /></div></div></div></div></div><div style={{marginLeft: 5, marginRight: 5, zIndex: 1000000, position: 'absolute', left: 0, bottom: 0}}><a target="_blank" href="https://maps.google.com/maps?ll=40.732432,-73.824808&z=15&t=m&hl=en-US&gl=US&mapclient=apiv3" title="Click to see this area on Google Maps" style={{position: 'static', overflow: 'visible', float: 'none', display: 'inline'}}><div style={{width: 66, height: 26, cursor: 'pointer'}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/google4.png" draggable="false" style={{position: 'absolute', left: 0, top: 0, width: 66, height: 26, userSelect: 'none', border: 0, padding: 0, margin: 0}} /></div></a></div><div style={{backgroundColor: 'white', padding: '15px 21px', border: '1px solid rgb(171, 171, 171)', fontFamily: 'Roboto, Arial, sans-serif', color: 'rgb(34, 34, 34)', boxShadow: 'rgba(0, 0, 0, 0.2) 0px 4px 16px', zIndex: 10000002, display: 'none', width: 256, height: 148, position: 'absolute', left: 94, top: 35}}><div style={{padding: '0px 0px 10px', fontSize: 16}}>Map Data</div><div style={{fontSize: 13}}>Map data ©2017 Google</div><div style={{width: 13, height: 13, overflow: 'hidden', position: 'absolute', opacity: '0.7', right: 12, top: 12, zIndex: 10000, cursor: 'pointer'}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/mapcnt6.png" draggable="false" style={{position: 'absolute', left: '-2px', top: '-336px', width: 59, height: 492, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div></div><div className="gmnoprint" style={{zIndex: 1000001, position: 'absolute', right: 166, bottom: 0, width: 121}}><div draggable="false" className="gm-style-cc" style={{userSelect: 'none', height: 14, lineHeight: 14}}><div style={{opacity: '0.7', width: '100%', height: '100%', position: 'absolute'}}><div style={{width: 1}} /><div style={{backgroundColor: 'rgb(245, 245, 245)', width: 'auto', height: '100%', marginLeft: 1}} /></div><div style={{position: 'relative', paddingRight: 6, paddingLeft: 6, fontFamily: 'Roboto, Arial, sans-serif', fontSize: 10, color: 'rgb(68, 68, 68)', whiteSpace: 'nowrap', direction: 'ltr', textAlign: 'right', verticalAlign: 'middle', display: 'inline-block'}}><a style={{color: 'rgb(68, 68, 68)', textDecoration: 'none', cursor: 'pointer', display: 'none'}}>Map Data</a><span>Map data ©2017 Google</span></div></div></div><div className="gmnoscreen" style={{position: 'absolute', right: 0, bottom: 0}}><div style={{fontFamily: 'Roboto, Arial, sans-serif', fontSize: 11, color: 'rgb(68, 68, 68)', direction: 'ltr', textAlign: 'right', backgroundColor: 'rgb(245, 245, 245)'}}>Map data ©2017 Google</div></div><div className="gmnoprint gm-style-cc" draggable="false" style={{zIndex: 1000001, userSelect: 'none', height: 14, lineHeight: 14, position: 'absolute', right: 95, bottom: 0}}><div style={{opacity: '0.7', width: '100%', height: '100%', position: 'absolute'}}><div style={{width: 1}} /><div style={{backgroundColor: 'rgb(245, 245, 245)', width: 'auto', height: '100%', marginLeft: 1}} /></div><div style={{position: 'relative', paddingRight: 6, paddingLeft: 6, fontFamily: 'Roboto, Arial, sans-serif', fontSize: 10, color: 'rgb(68, 68, 68)', whiteSpace: 'nowrap', direction: 'ltr', textAlign: 'right', verticalAlign: 'middle', display: 'inline-block'}}><a href="https://www.google.com/intl/en-US_US/help/terms_maps.html" target="_blank" style={{textDecoration: 'none', cursor: 'pointer', color: 'rgb(68, 68, 68)'}}>Terms of Use</a></div></div><div style={{cursor: 'pointer', width: 25, height: 25, overflow: 'hidden', display: 'none', margin: '10px 14px', position: 'absolute', top: 0, right: 0}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/sv9.png" draggable="false" className="gm-fullscreen-control" style={{position: 'absolute', left: '-52px', top: '-86px', width: 164, height: 175, userSelect: 'none', border: 0, padding: 0, margin: 0}} /></div><div draggable="false" className="gm-style-cc" style={{userSelect: 'none', height: 14, lineHeight: 14, position: 'absolute', right: 0, bottom: 0}}><div style={{opacity: '0.7', width: '100%', height: '100%', position: 'absolute'}}><div style={{width: 1}} /><div style={{backgroundColor: 'rgb(245, 245, 245)', width: 'auto', height: '100%', marginLeft: 1}} /></div><div style={{position: 'relative', paddingRight: 6, paddingLeft: 6, fontFamily: 'Roboto, Arial, sans-serif', fontSize: 10, color: 'rgb(68, 68, 68)', whiteSpace: 'nowrap', direction: 'ltr', textAlign: 'right', verticalAlign: 'middle', display: 'inline-block'}}><a target="_new" title="Report errors in the road map or imagery to Google" href="https://www.google.com/maps/@40.7324319,-73.8248078,15z/data=!10m1!1e1!12b1?source=apiv3&rapsrc=apiv3" style={{fontFamily: 'Roboto, Arial, sans-serif', fontSize: 10, color: 'rgb(68, 68, 68)', textDecoration: 'none', position: 'relative'}}>Report a map error</a></div></div><div className="gmnoprint gm-bundled-control gm-bundled-control-on-bottom" draggable="false" controlwidth={28} controlheight={55} style={{margin: 10, userSelect: 'none', position: 'absolute', bottom: 69, right: 28}}><div className="gmnoprint" controlwidth={28} controlheight={55} style={{position: 'absolute', left: 0, top: 0}}><div draggable="false" style={{userSelect: 'none', boxShadow: 'rgba(0, 0, 0, 0.3) 0px 1px 4px -1px', borderRadius: 2, cursor: 'pointer', backgroundColor: 'rgb(255, 255, 255)', width: 28, height: 55}}><div title="Zoom in" style={{position: 'relative', width: 28, height: 27, left: 0, top: 0}}><div style={{overflow: 'hidden', position: 'absolute', width: 15, height: 15, left: 7, top: 6}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/tmapctrl.png" draggable="false" style={{position: 'absolute', left: 0, top: 0, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none', width: 120, height: 54}} /></div></div><div style={{position: 'relative', overflow: 'hidden', width: '67%', height: 1, left: '16%', backgroundColor: 'rgb(230, 230, 230)', top: 0}} /><div title="Zoom out" style={{position: 'relative', width: 28, height: 27, left: 0, top: 0}}><div style={{overflow: 'hidden', position: 'absolute', width: 15, height: 15, left: 7, top: 6}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/tmapctrl.png" draggable="false" style={{position: 'absolute', left: 0, top: '-15px', userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none', width: 120, height: 54}} /></div></div></div></div><div className="gmnoprint" controlwidth={28} controlheight={0} style={{display: 'none', position: 'absolute'}}><div title="Rotate map 90 degrees" style={{width: 28, height: 28, overflow: 'hidden', position: 'absolute', borderRadius: 2, boxShadow: 'rgba(0, 0, 0, 0.3) 0px 1px 4px -1px', cursor: 'pointer', backgroundColor: 'rgb(255, 255, 255)', display: 'none'}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/tmapctrl4.png" draggable="false" style={{position: 'absolute', left: '-141px', top: 6, width: 170, height: 54, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div><div className="gm-tilt" style={{width: 28, height: 28, overflow: 'hidden', position: 'absolute', borderRadius: 2, boxShadow: 'rgba(0, 0, 0, 0.3) 0px 1px 4px -1px', top: 0, cursor: 'pointer', backgroundColor: 'rgb(255, 255, 255)'}}><img src="http://maps.gstatic.com/mapfiles/api-3/images/tmapctrl4.png" draggable="false" style={{position: 'absolute', left: '-141px', top: '-13px', width: 170, height: 54, userSelect: 'none', border: 0, padding: 0, margin: 0, maxWidth: 'none'}} /></div></div></div></div></div></div>
                                </div>
                              </div>
                            </div>
