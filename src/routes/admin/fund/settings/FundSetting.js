                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="main-box no-header">
                        <div id="formmessage" />
                        <form id="causeAuction" className="form" action="update" method="POST">
                          <input id="id" name="id" defaultValue={282} type="hidden" />
                          ...
                          <div className="row form-group">
                            ...
                            <div className="col-md-3">
                              <div className="onoffswitch onoffswitch-success">
                                <input type="checkbox" name="socialSharingEnabled" className="onoffswitch-checkbox" id="social" />
                          ...
                          <div className="row form-group">
                            ...
                            <div className="col-md-3">
                              <div className="onoffswitch onoffswitch-success">
                                <input id="categories" name="categoryEnabled" className="onoffswitch-checkbox" type="checkbox" defaultValue="true" defaultChecked="checked" /><input type="hidden" name="_categoryEnabled" defaultValue="on" />
                          ...
                          <div className="col-md-8">
                            ...
                            <table className="table category-settings-table">
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3516} />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3517} />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3518} />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3519} />
...
export default withStyles(s)(FundSetting);
