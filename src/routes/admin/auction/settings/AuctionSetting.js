                      ...
                      <div id className="clearfix">
                        <h1>
                          ...
                          <div className="pull-right">
                            <button className="btn btn-info btn-block save-settings" type="submit" onclick="$('.main-box > .form').submit();" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Saving Settings">Save Settings</button>
                          </div>
                        </h1>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className>
                      <div className="main-box no-header">
                          ...
                          <div className="row form-group">
                            ...
                            <div className="col-md-3">
                              <div className="input-group">
                                ...
                                <input type="text" className="form-control" name="defaultBidIncrement" id="defaultBid" defaultValue={10} />
                              </div>
                              <div className="hide" id="bidError">Bid increament must be greater than 0 or numeric.</div>
                            </div>
                          </div>
                          <div className="row form-group">
                            <div className="col-md-3 col-md-offset-1">
                          ...
                          <div className="col-md-8">
                            ...
                            <table className="table category-settings-table">
                              ...
                              <tr className="dummy edit">
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="text" className="form-control item-name" name="name" maxLength={25} placeholder required />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3511} />
                                  <input type="text" className="form-control item-name" name="name" defaultValue="Music" maxLength={25} required />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3510} />
                                  <input type="text" className="form-control item-name" name="name" defaultValue="Memorabilia" maxLength={25} required />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3509} />
                                  <input type="text" className="form-control item-name" name="name" defaultValue="Experiences" maxLength={25} required />
                              ...
                              <tr>
                                <td>
                                  <input type="hidden" name defaultValue />
                                  <input type="hidden" name="id" defaultValue={3508} />
                                  <input type="text" className="form-control item-name" name="name" defaultValue="Travel" maxLength={25} required />
                        ...
                        <div className="form-group operations-row text-center">
                          <button className="btn btn-info mrg-t-lg save-settings" type="submit" onclick="$('.main-box > .form').submit();" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Saving Settings">Save Settings</button>
                        </div>
                      </div> {/* /.form */}
                    </div>
                  </div>
...
export default withStyles(s)(AuctionSetting);
