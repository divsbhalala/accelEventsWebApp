                        ...
                        <div className="main-box-body clearfix">
                          ...
                          <form id="form" className="form ajax-form" data-validate-function="validateValues" action="design" method="post"><div className="ajax-msg-box text-center mrg-b-lg" style={{ display: 'none' }}><span className="fa fa-spinner fa-pulse fa-fw" /> <span className="resp-message" /></div><input type="hidden" name="_method" defaultValue="PUT" />
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="logoEnabled"
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="bannerImageEnabled"
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-9">
                                <CKEditor
                                  value={this.state.settings.desc}
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="txtMsgBidInstShown"
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="totalFundRaisedHidden"
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="countDownTimeHidden"
                            ...
                            <div className="row form-group">
                              ...
                              <div className="col-md-3">
                                <ToggleSwitch
                                  name="requireBidderAddress" id="socialSharingEnabled"
