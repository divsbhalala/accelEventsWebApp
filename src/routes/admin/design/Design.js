												...
												<div className="row form-group">
													...
													<div className="col-md-3">
														<div className="event-logo">
															<img
																src={this.state.settings.logoImage ? "http://v2-dev-images-public.s3-website-us-east-1.amazonaws.com/1-300x300/" + this.state.settings.logoImage : "http://v2-dev-images-public.s3-website-us-east-1.amazonaws.com/1-300x300/937320cf-a809-49c5-916d-e7436a1cfcaeaccelevents-logo-black.png"}
																alt className="img-responsive"/>
															<a role="button" onClick={this.showPopup} className="change-image-text">
																<img src="http://www.stagingaccel.com:8080/AccelEventsWebApp/img/photo-camera.png"/>
																Change Logo
															</a>
														</div>
													</div>
													...
													<div className="col-md-3">
														<div className="event-logo">
															<div className="banner-img">
																<img
																	src={this.state.settings.bannerImage ? "http://v2-dev-images-public.s3-website-us-east-1.amazonaws.com/1-300x300/" + this.state.settings.bannerImage : "http://v2-dev-images-public.s3-website-us-east-1.amazonaws.com/1-300x300/937320cf-a809-49c5-916d-e7436a1cfcaeaccelevents-logo-black.png"}
																	alt className="img-responsive "/>
