        ...
        <div className="row">
          <div className="col-lg-12">
            <div id="content-wrapper">
              <div className="row">
                <h1 className="text-center" style={{marginTop: 120, marginBottom: 0}}>Fund Goal</h1>
                <h4 className="text-center" style={{marginTop: 5}}> Text your Bid To: (410) 927-5356
                  with the item's three letter code and bid amount ex. ABC$300. </h4>
              </div>
              <div className="row">
                <div className="col-md-3">
                  {this.state.settings &&
                  <div id="countdownTimer"
                       className={cx("main-box clearfix project-box gray-box card")}>
                      ...
                      <div className={cx("project-box-content")}>
                        <div className={cx("value text-center")}>
                          <div className={cx("ticker big")}>
                                                        <span
                                                          className="total-funds-raised">{this.state.settings.totalFundRaised}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className={cx("ticker big")}>
                          <div className={cx("row timer")}>
                            ...
                            <div className={cx("col-xs-4")}><span className={cx("minutes")}>{
                              ...
                              || '00'}</span></div>
                            <div className={cx("col-xs-4")}><span className={cx("seconds")}>00</span>
                            </div>
                          </div>
                          <div className={cx("row tiny text-center")}>
                            <div className={cx("col-xs-4")}><span className={cx("hours")}>HOURS</span>
                            </div>
                            <div className={cx("col-xs-4")}><span className={cx("minutes")}>MINUTES</span>
                            </div>
                            <div className={cx("col-xs-4")}><span className={cx("seconds")}>SECONDS</span>
                            </div>
                          </div>
                        </div>
                      </div>
