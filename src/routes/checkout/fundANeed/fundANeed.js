  ...
  onFormClick = (e) => {
    ...
    if (0){
      ...
      if(  !this.state.settings.creditCardRequired ) {
        ...
        if (this.state.cardNumber && this.state.cardHolder && this.state.total && this.state.cvv) {
          const card = {
                      ...
                      <div className>
                        <table className="table items-table">
                          ...
                          <tr>
                            ...
                            <th className="text-right"><span>Pledge</span></th>
                          </tr>
                          </thead>
                          <tbody>
                          ...
                          <tr>
                            <td colSpan={4} className="text-right">
                              Total: $<span className="sub-total-amount">{this.state.total}</span>
                            </td>
                          </tr>
                          <tr>
                            <td colSpan={4} className="text-right">
