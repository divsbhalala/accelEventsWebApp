...
class FundANeed extends React.Component {
  ...
  confirmDonationCheckout = (confirmBidDto) =>{
  ...
  componentDidMount(){
    ...
    this.props.getdDonationCheckout(this.props.params &&  this.props.params.params , this.props.params &&  this.props.params.ItemCode).then(resp => {
      console.log(resp)
