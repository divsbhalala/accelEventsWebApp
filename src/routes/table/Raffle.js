...
import {doGetRaffleItemByLimit, doGetSettings,doGetEventData} from './../event/action/index';
          ...
          <div id="content-wrapper">
            <div className="row">
              <div className="col-lg-3 col-md-4 col-sm-4">
                {console.log("evdata",this.props.eventData),
                  console.log("settign",this.state.settings),
                  console.log("eventTicketData",this.props.eventTicketData)
                }
