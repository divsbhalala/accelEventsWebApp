  ...
  render() {
    let form_login = <form className="ajax-form validated fv-form fv-form-bootstrap" method="post" onSubmit={this.submiteBuyTicket}>
      ...
      <div className="row btn-row">
        <div className="col-md-5 col-lg-5">
          <Button  className={cx("btn btn-primary text-uppercase",  s.btnFull)} style={{width:"100%"}} disabled={!this.state.isValidData } role="button"
                   type="submit"  loading={this.state.loading}> Submit Ticket</Button>

        </div>
        <div className="col-md-6 col-lg-5">
          <Link to={this.props.params && "/event/" + this.props.params.params + '#Raffle' } role="button" className="btn btn-success btn-block" >
    ...
    let form_normal = <div >
      ...
      <Link role="button" className="btn btn-success btn-block"
         to={this.props.params && "/event/" + this.props.params.params + '#Raffle' } >Go back to All Items</Link>
    </div>;
    return (
      <div className="row">
