    ...
    render() {
        var form_login = <form className="ajax-form validated fv-form fv-form-bootstrap" method="post"
            ...
            <div className="form-group has-feedback">
                <label className="control-label"> You have <span className="available-tickets">0</span> tickets remaining.</label>
                <div className="row">
                    <div className="col-md-5 col-lg-5">
                        <div className="input-group">
                            <div className="input-group-addon"> <i className="fa fa-ticket" aria-hidden="true" /></div>
                            <input type="number" className="form-control" name="itembid" disabled="disabled" required="required" data-isprocessingfeestopurchaser="false" data-fv-field="itembid" />
                        </div><i className="form-control-feedback fv-bootstrap-icon-input-group" data-fv-icon-for="itembid" style={{display: 'none'}} />
                        <small className="help-block" data-fv-result="NOT_VALIDATED" style={{display: 'none'}}>Number of Tickets should be greater than zero.</small><small className="help-block" data-fv-result="NOT_VALIDATED" style={{display: 'none'}}>Digits Only Accepted.</small><small className="help-block" data-fv-validator="callback" data-fv-for="itembid" data-fv-result="NOT_VALIDATED" style={{display: 'none'}}>Tickets should be more than 0 and less than 0</small><small className="help-block" data-fv-validator="integer" data-fv-for="itembid" data-fv-result="NOT_VALIDATED" style={{display: 'none'}}>This value is not valid</small></div>
                </div>
            </div>
            <div className="row btn-row">
                <div className="col-md-5 col-lg-5">
                    <button className={cx("btn btn-primary text-uppercase",s.btnFull,!this.state.isValidData && 'disabled')} role="button" type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Getting Started..">
                        Submit Tickets
                    </button>
            ...
            <div className="row mrg-t-md">
                <div className="col-md-5 col-lg-10">
                    <button className={cx("btn btn-primary text-uppercase", s.btnFull)} role="button" type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Getting Started..">
                        Get Tickets
                    </button>
                   </div>
            </div>
                    ...
                    <div id="content-wrapper">
                        <div className="row">
                            <div className="col-lg-3 col-md-4 col-sm-4">
                                ...
                                <EventAside activeTab={'Raffle'} eventData={this.props.eventData} settings={this.state.settings} eventTicketData={this.props.eventTicketData}
                                             activeCategory={false} />
                            </div>
                            <div className="col-lg-9 col-md-8 col-sm-8">
                                <div className="main-box clearfix">
                                    <h1 className="text-center mrg-t-lg" id="item-name">{this.state.raffleData && this.state.raffleData.name}</h1>
                                    <div className="row mrg-t-lg">
                                        <div className="col-md-6">
                                            <div className="pad-l-md pad-r-md">
                                                <div className="item-image">
                                                    <div className="item-image-inner" style={{backgroundImage: 'url('+imageUrl+')', width: '', transform: 'rotate(0deg)'}} />
                                                </div>
                                            </div>
